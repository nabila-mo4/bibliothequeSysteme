					...
					<div class="panel-body">
						<div class="row">
							<div class=" col-lg-8 col-lg-offset-2 col-lg-offset-2">
									...
									<h5>Nom du site </h5>	<label for="nom"  tabindex="1" class="form-control"  style="height: 45px;border: 1px solid #ddd;font-size: 16px;-webkit-transition: all 0.1s linear;-moz-transition: all 0.1s linear;transition: all 0.1s linear;" > ${siteForm.nomsite } </label>
					    ...
					    <div class=" col-md-12 text-center"><a href="<c:url value="/addcommentaire/${idsite }"></c:url>" style="text-align: left; color: #007bff;">Vous avez un avis à partager sur ce site, c'est par ici ...</a></div>
					</div>
